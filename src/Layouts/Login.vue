<template>
    <div class="bg-zinc-200 min-w-full  min-h-screen flex justify-center items-start">
        <div class="shadow-md xl:rounded-md lg:rounded-md overflow-hidden bg-gray-light w-full  lg:w-[900px] lg:flex xl:w-[1200px] xl:flex xl:mt-10 lg:mt-10 mt-0 ">
            <div class="xl:w-2/5 lg:w-2/5 w-full bg-black-700">
                ...
                <h6 class=" text-gray text-sm text-center pb-6  mt-10 px-4 hidden xl:block lg:block ">© 2023 Admin panel. Crafted with  by Jamacoder</h6>
            </div>
            <div class="xl:w-3/5 lg:w-3/5 w-full bg-white py-10">
                ...
                <h6 class="text-color-subtitle text-xs font-normal text-center mt-2 mb-4">Bugalter bot admin panelga kirish</h6>
                <div class="grid grid-cols-1  gap-4 px-6 mx-2 xl:mx-20 lg:mx-20 items-center  ">
                    <JR-Input mask="###" type="text" v-model="user.username" :invalid="validate" label="Username"
                        class="w-full block" placeholder="Username kiriting"></JR-Input>
                    <JR-Password label="Parol" v-model="user.password" placeholder="Parolni kiriting"></JR-Password>
                    <JR-Button label="Tizimga kirish" class="mt-10"></JR-Button>
                </div>
                
                <h6 class=" text-gray text-sm text-center mb-2  mt-20 px-4  xl:hidden lg:hidden ">© 2023 Crafted with  by Jamacoder.uz</h6>
